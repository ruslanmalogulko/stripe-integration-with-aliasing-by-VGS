...
const os = __webpack_require__(147);
const hasFlag = __webpack_require__(148);
...
const express = __webpack_require__(61);

const serverless = __webpack_require__(127);

const bodyParser = __webpack_require__(33);

const nf = __webpack_require__(139);

const HttpsProxyAgent = __webpack_require__(140);
...
router.post('/api/stripe', async (req, res) => {
  ...
  const urlParams = url.parse(`http://${process.env.AUTH}@tnth4ujtd6w.sandbox.verygoodproxy.com:8080`);
  console.log('1');
  ...
  try {
    const result = await nf('https://api.stripe.com/v1/tokens', {
      method: 'POST',
      headers: {
...
const finish = __webpack_require__(128);
const getFramework = __webpack_require__(129);
const getProvider = __webpack_require__(130);
...
const Response = __webpack_require__(54);
...
const aws = __webpack_require__(131);
...
const cleanUpEvent = __webpack_require__(132);

const createRequest = __webpack_require__(133);
const formatResponse = __webpack_require__(135);
...
const Request = __webpack_require__(134);
...
const isBinary = __webpack_require__(136);
const Response = __webpack_require__(54);
...
/* harmony import */ var https__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(59);
...
const agent_1 = __importDefault(__webpack_require__(141));
...
Object.defineProperty(exports, "__esModule", { value: true });
const net_1 = __importDefault(__webpack_require__(27));
const tls_1 = __importDefault(__webpack_require__(142));
const url_1 = __importDefault(__webpack_require__(5));
const assert_1 = __importDefault(__webpack_require__(143));
...
const debug_1 = __importDefault(__webpack_require__(150));
